...
void tInvader::LoadStage1()  // Carregar Imatges !!!
{
 ...
 if(!CarregarImatgeVScreen((byte *)&"grafics//blocs1.raw",BUFFER1)) Quit(Motiu2);
 ...
 if(!CarregarImatgeVScreen((byte *)&"grafics//sprites1.raw",BUFFER1)) Quit(Motiu3);
...
// Sprites 64 X 64
 ...
 // Inicialitzem Objectes...
  ...
  Objectes[BALA_ENEMIC_1].AfegirFrame(1,0,2,NO);
  Objectes[BALA_ENEMIC_1].AfegirFrame(1,1,2,NO);
