...
int main(int argc, char *argv[]){
    ...
    std::vector<InvaderGraphicFile> image_files={
        ...
        ,{"MEDFNT.RAW",INVADER_MED_FONT_LETTER_WIDTH*INVADER_MED_FONT_NUM_LETTERS,INVADER_MED_FONT_LETTER_HEIGHT}
        ,{"NAU00.RAW",206,97}
        ,{"NAUINT.RAW",INVADER_WINDOW_WIDTH,INVADER_WINDOW_HEIGHT}
